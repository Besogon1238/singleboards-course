...
Перейдем на [страницу регулярных сборок altlinux для riscv64](https://www.altlinux.org/Regular/riscv64) и выберем тарболл по возможностям платы. 

Допустим, остановbvcz на тарболле с [xfce](https://nightly.altlinux.org/sisyphus-riscv64/current/regular-xfce-latest-riscv64.tar.xz).
