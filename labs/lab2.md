...
Ознакомившись с подготовительным материалом к лабораторным №1 и лабораторным №2 осуществить запуск одноплатника Lichee RV Dock с операционной системой Linux и решить слудующие подзадачи:
