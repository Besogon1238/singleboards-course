...
(само собой эта весьма нетривильная задача, требующая знания схемы и распиновки устройства, и вряд ли она встанет перед тем, кто портирует линукс на железку выпускаемую большим производителем).
